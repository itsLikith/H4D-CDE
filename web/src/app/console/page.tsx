...
export default function MissionControlConsolePage() {
  // Scenario state
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#06080D] text-foreground">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-3 p-3 min-h-0 overflow-hidden">
        ...
        <div className="lg:col-span-4 h-full flex flex-col min-h-0">
          ...
          >
            {/* Tab Triggers */}
            <TabsList className="grid grid-cols-4 w-full h-9 bg-white/[0.02] border border-white/[0.08] p-1 mb-2 font-mono text-[11px]">
